...
class ParserConfig(Base):
    ...
    # ── Enflame 定制字段（前端 chunk-method-dialog / dataset 接口会回传，缺失则 extra="forbid" 拒绝保存）──
    llm_id: Annotated[str | None, Field(default=None)]
    children_delimiter: Annotated[str, Field(default=r"\n")]
    enable_children: Annotated[bool, Field(default=False)]
    toc_extraction: Annotated[bool, Field(default=False)]
    image_table_context_window: Annotated[int, Field(default=0)]
    mineru_parse_method: Annotated[str, Field(default="auto")]
    mineru_formula_enable: Annotated[bool, Field(default=True)]
    mineru_table_enable: Annotated[bool, Field(default=True)]
    mineru_lang: Annotated[str, Field(default="English")]
    overlapped_percent: Annotated[float, Field(default=0.0)]
    image_context_size: Annotated[int, Field(default=0)]
    table_context_size: Annotated[int, Field(default=0)]
    enable_metadata: Annotated[bool, Field(default=False)]
    metadata: Annotated[dict[str, Any], Field(default={})]
    built_in_metadata: Annotated[list[Any], Field(default=[])]

...
class ParserConfig(Base):
    ...
    overlapped_percent: Annotated[float | None, Field(default=None, ge=0, le=100)]
    ...
    built_in_metadata: Annotated[list, Field(default_factory=list)]
    enable_metadata: Annotated[bool, Field(default=False)]
    metadata: Annotated[dict, Field(default_factory=dict)]
    tenant_llm_id: Annotated[int | None, Field(default=None)]
